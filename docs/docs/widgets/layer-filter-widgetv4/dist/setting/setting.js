System.register(["jimu-core/react","jimu-core","jimu-ui/advanced/setting-components","jimu-ui/advanced/data-source-selector","jimu-ui"], function(__WEBPACK_DYNAMIC_EXPORT__, __system_context__) {
...
"use strict";
/*!*******************************************************************************!*\
  !*** ./your-extensions/widgets/layer-filter-widgetv3/src/setting/setting.tsx ***!
  \*******************************************************************************/
...
class Setting extends jimu_core__WEBPACK_IMPORTED_MODULE_1__.React.PureComponent {
    constructor(props) {
        super(props);
        this.loadAvailableFields = () => __awaiter(this, void 0, void 0, function* () {
            const { config } = this.props;
            if (!(config === null || config === void 0 ? void 0 : config.layerId))
                return;
            this.setState({ loadingFields: true });
            try {
                const dataSource = jimu_core__WEBPACK_IMPORTED_MODULE_1__.DataSourceManager.getInstance().getDataSource(config.layerId);
                ...
                const availableFields = fields
                    .filter(field => ['string', 'small-integer', 'integer', 'double'].includes(field.type))
                    .map(field => ({
                    name: field.name,
        ...
        this.onDataSourceChange = (useDataSources) => {
            ...
            if (!useDataSources || useDataSources.length === 0)
                return;
            const layerId = ((_a = useDataSources[0]) === null || _a === void 0 ? void 0 : _a.dataSourceId) || '';
            this.props.onSettingChange({
                id: this.props.id,
        ...
        this.onFieldToggle = (fieldName, checked) => {
            const { config } = this.props;
            let allowedFields = (config === null || config === void 0 ? void 0 : config.allowedFields) || [];
            if (checked) {
        ...
        const config = props.config || (0,jimu_core__WEBPACK_IMPORTED_MODULE_1__.Immutable)({ layerId: '', allowedFields: [] });
        this.state = {
    ...
    componentDidMount() {
        var _a;
        if ((_a = this.props.config) === null || _a === void 0 ? void 0 : _a.layerId) {
            this.loadAvailableFields();
        }
    }
    componentDidUpdate(prevProps) {
        var _a, _b, _c;
        if (((_a = this.props.config) === null || _a === void 0 ? void 0 : _a.layerId) !== ((_b = prevProps.config) === null || _b === void 0 ? void 0 : _b.layerId) &&
            ((_c = this.props.config) === null || _c === void 0 ? void 0 : _c.layerId)) {
            this.loadAvailableFields();
        }
    }
    render() {
        ...
        const allowedFields = (config === null || config === void 0 ? void 0 : config.allowedFields) || [];
        if (!config) {
            return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { style: { padding: '1rem', color: '#999' }, children: "Configuration not loaded." });
        }
        return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", { css: { width: '100%', height: '100%', padding: '16px' }, children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(jimu_ui_advanced_setting_components__WEBPACK_IMPORTED_MODULE_2__.SettingSection, { title: "Map Configuration", children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(jimu_ui_advanced_setting_components__WEBPACK_IMPORTED_MODULE_2__.SettingRow, { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", { style: { width: '100%' }, children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("label", { style: { fontWeight: 'bold', marginBottom: '8px', display: 'block' }, children: "Select Map Widget:" }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(jimu_ui_advanced_setting_components__WEBPACK_IMPORTED_MODULE_2__.MapWidgetSelector, { onSelect: this.onMapWidgetSelected, useMapWidgetIds: this.props.useMapWidgetIds })] }) }) }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(jimu_ui_advanced_setting_components__WEBPACK_IMPORTED_MODULE_2__.SettingSection, { title: "Data Source Configuration", children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(jimu_ui_advanced_setting_components__WEBPACK_IMPORTED_MODULE_2__.SettingRow, { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", { style: { width: '100%' }, children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("label", { style: { fontWeight: 'bold', marginBottom: '8px', display: 'block' }, children: "Select Layer to Filter:" }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(jimu_ui_advanced_data_source_selector__WEBPACK_IMPORTED_MODULE_3__.DataSourceSelector, { types: (0,jimu_core__WEBPACK_IMPORTED_MODULE_1__.Immutable)([jimu_core__WEBPACK_IMPORTED_MODULE_1__.AllDataSourceTypes.FeatureLayer]), useDataSources: useDataSources, mustUseDataSource: true, onChange: this.onDataSourceChange, widgetId: this.props.id })] }) }), (config === null || config === void 0 ? void 0 : config.layerId) && ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(jimu_ui_advanced_setting_components__WEBPACK_IMPORTED_MODULE_2__.SettingRow, { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { style: {
                                    padding: '12px',
                                    backgroundColor: '#f0f8ff',
                                    borderRadius: '4px',
                                    border: '1px solid #d1ecf1'
                                }, children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("p", { style: { margin: 0, fontSize: '14px', color: '#0c5460' }, children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("strong", { children: "Selected Layer ID:" }), " ", config.layerId] }) }) }))] }), (config === null || config === void 0 ? void 0 : config.layerId) && ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(jimu_ui_advanced_setting_components__WEBPACK_IMPORTED_MODULE_2__.SettingSection, { title: "Field Configuration", children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(jimu_ui_advanced_setting_components__WEBPACK_IMPORTED_MODULE_2__.SettingRow, { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", { style: { width: '100%' }, children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("label", { style: { fontWeight: 'bold', marginBottom: '12px', display: 'block' }, children: "Select Fields Available to Users:" }), loadingFields ? ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { style: { padding: '16px', textAlign: 'center', color: '#666' }, children: "Loading available fields..." })) : availableFields.length > 0 ? ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { style: {
                                        maxHeight: '300px',
                                        overflowY: 'auto',
                                        border: '1px solid #dee2e6',
                                        borderRadius: '4px',
                                        padding: '8px'
                                    }, children: availableFields.map(field => ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", { style: {
                                            display: 'flex',
                                            alignItems: 'center',
                                            padding: '8px',
                                            borderBottom: '1px solid #f0f0f0'
                                        }, children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(jimu_ui__WEBPACK_IMPORTED_MODULE_4__.Checkbox, { checked: allowedFields.includes(field.name), onChange: (e) => this.onFieldToggle(field.name, e.target.checked), style: { marginRight: '12px' } }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", { style: { flex: 1 }, children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { style: { fontWeight: 'bold', fontSize: '14px' }, children: field.alias }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", { style: { fontSize: '12px', color: '#999' }, children: [field.name, " (", field.type, ")"] })] })] }, field.name))) })) : ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { style: { padding: '16px', textAlign: 'center', color: '#999' }, children: "No compatible fields found in the selected layer." })), allowedFields.length > 0 && ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", { style: {
                                        marginTop: '12px',
                                        padding: '12px',
                                        backgroundColor: '#f8f9fa',
                                        borderRadius: '4px'
                                    }, children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("strong", { children: ["Selected Fields (", allowedFields.length, "):"] }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { style: { marginTop: '4px', fontSize: '12px' }, children: allowedFields.join(', ') })] }))] }) }) }))] }));
    }
}
